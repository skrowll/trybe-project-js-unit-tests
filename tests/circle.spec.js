...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(circle(!typeof Number)).toEqual(undefined);

    // Teste se circle retorna um objeto.
    expect(typeof circle(100)).toBe('object');

    // Teste se o objeto retornado tem 3 propriedades.
    expect(Object.keys(circle(100)).length).toEqual(3); //https://pt.stackoverflow.com/questions/15058/como-saber-o-tamanho-quantidade-de-propriedades-atributos-de-um-objeto-em-ja
    ...
    expect(circle(3).area).toEqual(3.14 * 3 * 3);
    expect(circle(3).circumference).toEqual(2 * 3.14 * 3);
